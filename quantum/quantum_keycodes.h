...
// MIDI aliases
#define MIDI_TONE_MIN QK_MIDI_NOTE_C_N1
#define MIDI_TONE_MAX QK_MIDI_NOTE_G_9
...
#define MIDI_VOLUME_MIN QK_MIDI_VOLUME_0
#define MIDI_VOLUME_MAX QK_MIDI_VOLUME_10
