...
std::map<uint16_t, std::string> KEYCODE_ID_TABLE = {
    ...
    {QK_MIDI_NOTE_C_N1, "QK_MIDI_NOTE_C_N1"},
    {QK_MIDI_NOTE_C_SHARP_N1, "QK_MIDI_NOTE_C_SHARP_N1"},
    {QK_MIDI_NOTE_D_N1, "QK_MIDI_NOTE_D_N1"},
    {QK_MIDI_NOTE_D_SHARP_N1, "QK_MIDI_NOTE_D_SHARP_N1"},
    {QK_MIDI_NOTE_E_N1, "QK_MIDI_NOTE_E_N1"},
    {QK_MIDI_NOTE_F_N1, "QK_MIDI_NOTE_F_N1"},
    {QK_MIDI_NOTE_F_SHARP_N1, "QK_MIDI_NOTE_F_SHARP_N1"},
    {QK_MIDI_NOTE_G_N1, "QK_MIDI_NOTE_G_N1"},
    {QK_MIDI_NOTE_G_SHARP_N1, "QK_MIDI_NOTE_G_SHARP_N1"},
    {QK_MIDI_NOTE_A_N1, "QK_MIDI_NOTE_A_N1"},
    {QK_MIDI_NOTE_A_SHARP_N1, "QK_MIDI_NOTE_A_SHARP_N1"},
    {QK_MIDI_NOTE_B_N1, "QK_MIDI_NOTE_B_N1"},
    {QK_MIDI_NOTE_C, "QK_MIDI_NOTE_C"},
    {QK_MIDI_NOTE_C_SHARP, "QK_MIDI_NOTE_C_SHARP"},
    {QK_MIDI_NOTE_D, "QK_MIDI_NOTE_D"},
    {QK_MIDI_NOTE_D_SHARP, "QK_MIDI_NOTE_D_SHARP"},
    {QK_MIDI_NOTE_E, "QK_MIDI_NOTE_E"},
    {QK_MIDI_NOTE_F, "QK_MIDI_NOTE_F"},
    {QK_MIDI_NOTE_F_SHARP, "QK_MIDI_NOTE_F_SHARP"},
    {QK_MIDI_NOTE_G, "QK_MIDI_NOTE_G"},
    {QK_MIDI_NOTE_G_SHARP, "QK_MIDI_NOTE_G_SHARP"},
    {QK_MIDI_NOTE_A, "QK_MIDI_NOTE_A"},
    {QK_MIDI_NOTE_A_SHARP, "QK_MIDI_NOTE_A_SHARP"},
    {QK_MIDI_NOTE_B, "QK_MIDI_NOTE_B"},
    ...
    {QK_MIDI_NOTE_C_6, "QK_MIDI_NOTE_C_6"},
    {QK_MIDI_NOTE_C_SHARP_6, "QK_MIDI_NOTE_C_SHARP_6"},
    {QK_MIDI_NOTE_D_6, "QK_MIDI_NOTE_D_6"},
    {QK_MIDI_NOTE_D_SHARP_6, "QK_MIDI_NOTE_D_SHARP_6"},
    {QK_MIDI_NOTE_E_6, "QK_MIDI_NOTE_E_6"},
    {QK_MIDI_NOTE_F_6, "QK_MIDI_NOTE_F_6"},
    {QK_MIDI_NOTE_F_SHARP_6, "QK_MIDI_NOTE_F_SHARP_6"},
    {QK_MIDI_NOTE_G_6, "QK_MIDI_NOTE_G_6"},
    {QK_MIDI_NOTE_G_SHARP_6, "QK_MIDI_NOTE_G_SHARP_6"},
    {QK_MIDI_NOTE_A_6, "QK_MIDI_NOTE_A_6"},
    {QK_MIDI_NOTE_A_SHARP_6, "QK_MIDI_NOTE_A_SHARP_6"},
    {QK_MIDI_NOTE_B_6, "QK_MIDI_NOTE_B_6"},
    {QK_MIDI_NOTE_C_7, "QK_MIDI_NOTE_C_7"},
    {QK_MIDI_NOTE_C_SHARP_7, "QK_MIDI_NOTE_C_SHARP_7"},
    {QK_MIDI_NOTE_D_7, "QK_MIDI_NOTE_D_7"},
    {QK_MIDI_NOTE_D_SHARP_7, "QK_MIDI_NOTE_D_SHARP_7"},
    {QK_MIDI_NOTE_E_7, "QK_MIDI_NOTE_E_7"},
    {QK_MIDI_NOTE_F_7, "QK_MIDI_NOTE_F_7"},
    {QK_MIDI_NOTE_F_SHARP_7, "QK_MIDI_NOTE_F_SHARP_7"},
    {QK_MIDI_NOTE_G_7, "QK_MIDI_NOTE_G_7"},
    {QK_MIDI_NOTE_G_SHARP_7, "QK_MIDI_NOTE_G_SHARP_7"},
    {QK_MIDI_NOTE_A_7, "QK_MIDI_NOTE_A_7"},
    {QK_MIDI_NOTE_A_SHARP_7, "QK_MIDI_NOTE_A_SHARP_7"},
    {QK_MIDI_NOTE_B_7, "QK_MIDI_NOTE_B_7"},
    {QK_MIDI_NOTE_C_8, "QK_MIDI_NOTE_C_8"},
    {QK_MIDI_NOTE_C_SHARP_8, "QK_MIDI_NOTE_C_SHARP_8"},
    {QK_MIDI_NOTE_D_8, "QK_MIDI_NOTE_D_8"},
    {QK_MIDI_NOTE_D_SHARP_8, "QK_MIDI_NOTE_D_SHARP_8"},
    {QK_MIDI_NOTE_E_8, "QK_MIDI_NOTE_E_8"},
    {QK_MIDI_NOTE_F_8, "QK_MIDI_NOTE_F_8"},
    {QK_MIDI_NOTE_F_SHARP_8, "QK_MIDI_NOTE_F_SHARP_8"},
    {QK_MIDI_NOTE_G_8, "QK_MIDI_NOTE_G_8"},
    {QK_MIDI_NOTE_G_SHARP_8, "QK_MIDI_NOTE_G_SHARP_8"},
    {QK_MIDI_NOTE_A_8, "QK_MIDI_NOTE_A_8"},
    {QK_MIDI_NOTE_A_SHARP_8, "QK_MIDI_NOTE_A_SHARP_8"},
    {QK_MIDI_NOTE_B_8, "QK_MIDI_NOTE_B_8"},
    {QK_MIDI_NOTE_C_9, "QK_MIDI_NOTE_C_9"},
    {QK_MIDI_NOTE_C_SHARP_9, "QK_MIDI_NOTE_C_SHARP_9"},
    {QK_MIDI_NOTE_D_9, "QK_MIDI_NOTE_D_9"},
    {QK_MIDI_NOTE_D_SHARP_9, "QK_MIDI_NOTE_D_SHARP_9"},
    {QK_MIDI_NOTE_E_9, "QK_MIDI_NOTE_E_9"},
    {QK_MIDI_NOTE_F_9, "QK_MIDI_NOTE_F_9"},
    {QK_MIDI_NOTE_F_SHARP_9, "QK_MIDI_NOTE_F_SHARP_9"},
    {QK_MIDI_NOTE_G_9, "QK_MIDI_NOTE_G_9"},
    ...
    {QK_MIDI_VOLUME_0, "QK_MIDI_VOLUME_0"},
    {QK_MIDI_VOLUME_1, "QK_MIDI_VOLUME_1"},
    {QK_MIDI_VOLUME_2, "QK_MIDI_VOLUME_2"},
    {QK_MIDI_VOLUME_3, "QK_MIDI_VOLUME_3"},
    {QK_MIDI_VOLUME_4, "QK_MIDI_VOLUME_4"},
    {QK_MIDI_VOLUME_5, "QK_MIDI_VOLUME_5"},
    {QK_MIDI_VOLUME_6, "QK_MIDI_VOLUME_6"},
    {QK_MIDI_VOLUME_7, "QK_MIDI_VOLUME_7"},
    {QK_MIDI_VOLUME_8, "QK_MIDI_VOLUME_8"},
    {QK_MIDI_VOLUME_9, "QK_MIDI_VOLUME_9"},
    {QK_MIDI_VOLUME_10, "QK_MIDI_VOLUME_10"},
    {QK_MIDI_VOLUME_DOWN, "QK_MIDI_VOLUME_DOWN"},
    {QK_MIDI_VOLUME_UP, "QK_MIDI_VOLUME_UP"},
